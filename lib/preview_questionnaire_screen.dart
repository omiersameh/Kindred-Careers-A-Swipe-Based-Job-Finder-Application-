...
// ============================================================
// SCREEN: PreviewQuestionnaireScreen
// Preview version of QuestionnaireScreen filled with Arabic mock data.
// ============================================================

class PreviewQuestionnaireScreen extends StatefulWidget {
  const PreviewQuestionnaireScreen({super.key});

  @override
  State<PreviewQuestionnaireScreen> createState() => _PreviewQuestionnaireScreenState();
}

class _PreviewQuestionnaireScreenState extends State<PreviewQuestionnaireScreen> {
  ...
  void initState() {
    super.initState();
    _emailCtrl.text = 'omier.sameh@kindred.com';
    _prefillMockData();
  }

  void _prefillMockData() {
    _firstNameCtrl.text = 'Omier';
    _lastNameCtrl.text = 'Sameh';
    _locationCtrl.text = '6th of October City, Giza, Egypt';
    _ageCtrl.text = '23';
    _phoneCtrl.text = '+201112223333';
    _emailCtrl.text = 'omier.sameh@kindred.com';

    _educationStatus = "Bachelor's Degree";
    _institutionCtrl.text = 'Cairo University';
    _degreeCtrl.text = 'Bachelor of Science in Computer Science';
    _fieldOfStudyCtrl.text = 'Software Engineering';
    _gradYearCtrl.text = '2025';

    _selectedFieldIds.addAll(['technology', 'art']);
    _selectedSpecializations['technology'] = {
      'Mobile App Developer',
      'Web Developer / Frontend'
    };
    _selectedSpecializations['art'] = {
      'UI / UX Designer (Creative)'
    };

    _bioCtrl.text =
        'Passionate Software Engineer and UI/UX Designer based in Egypt. I specialize in building high-performance mobile applications with Flutter and designing premium, modern user interfaces that look outstanding and feel extremely responsive.';

    _credentials.addAll([
      {
        'title': 'Advanced Flutter Development Specialization',
      ...
      {
        'title': 'Next.js & React Web Architecture',
        'issuer': 'Udacity',
        'year': '2023'
      }
    ]);
    ...
    _experiences.addAll([
      Experience(
        ...
        company: 'IT Solutions Egypt',
        startDate: 'Aug 2024',
        endDate: 'Present',
        description: 'Developing cross-platform mobile applications for local and regional clients, optimizing screen rendering performance, and integrating RESTful APIs and modern state management.',
      ),
      Experience(
        id: 'exp_mock_2',
        ...
        startDate: 'Jun 2023',
        endDate: 'Sep 2023',
        description: 'Assisted in frontend web development using React.js and participated in Agile sprint ceremonies, developing clean code and collaborating with backend teams.',
      ),
    ]);
  }
